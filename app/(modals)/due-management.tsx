...
const PaymentModal: React.FC<PaymentModalProps> = ({ visible, customer, onClose, onSubmit }) => {
                ...
                {paymentModes.map((mode) => (
                  <TouchableOpacity
                    ...
                    style={{
                      ...
                      borderRadius: 20,
                      borderWidth: 1,
                      borderColor: paymentMode === mode ? theme.colors.primary : "#d1d5db",
                      backgroundColor: paymentMode === mode ? theme.colors.primary : "white",
                      marginRight: 8,
                      marginBottom: 8,
                    }}
                  >
                    <Text style={{
                      color: paymentMode === mode ? "white" : theme.colors.text,
                      fontSize: 14,
                      fontWeight: "500",
                    }}>
                      {mode}
...
export default function DueManagementScreen() {
  ...
  const handleCustomerPress = (customer: CustomerDue) => {
  ...
  const renderCustomerItem = ({ item }: { item: CustomerDue }) => (
    <TouchableOpacity
        ...
        <View style={{ flex: 1 }}>
          ...
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            ...
            <Text style={{
              ...
              {item.unpaidKots.length} unpaid order{item.unpaidKots.length !== 1 ? 's' : ''}
            </Text>
          </View>
        </View>
      ...
      <View style={{ flex: 1 }}>
        ...
        <View style={{
          ...
          <Text style={{
            ...
            {customersWithDues.length} customer{customersWithDues.length !== 1 ? 's' : ''} with pending dues
          </Text>
        </View>
