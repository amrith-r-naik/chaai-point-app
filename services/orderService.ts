    ...
    try {
      ...
      for (const [customerId, customerData] of Object.entries(kotsByCustomer)) {
        try {
          ...
          // Process as credit payment (amount is already in paisa, convert to rupees for processPayment)
          await paymentService.processPayment({
            billId: '', // Will be generated by createBill in processPayment
            customerId: customerId,
            customerName: customerData.customerName,
            totalAmount: customerData.totalAmount / 100, // Convert from paisa to rupees
            paymentType: 'Credit',
      ...
      return { 
        ...
        totalAmount: totalProcessedAmount / 100 // Convert to rupees
      };
